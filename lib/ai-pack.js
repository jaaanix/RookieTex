...
module.exports = {
  ...
  activate: function () {
    ...
    atom.commands.add('atom-workspace', 'ai-pack:addBegin', templatesjs.addBegin);
    atom.commands.add('atom-workspace', 'ai-pack:addOrderedList', templatesjs.addOrderedList);
    atom.commands.add('atom-workspace', 'ai-pack:addBackslash', templatesjs.addBackslash);
    atom.commands.add('atom-workspace', 'ai-pack:addCodeSnippet', templatesjs.addCodeSnippet);
    atom.commands.add('atom-workspace', 'ai-pack:addFigure', templatesjs.addFigure);
    atom.commands.add('atom-workspace', 'ai-pack:addMinipage', templatesjs.addMinipage);
    atom.commands.add('atom-workspace', 'ai-pack:makeTypewriter', converterjs.makeTypewriter);
    atom.commands.add('atom-workspace', 'ai-pack:makeSmallCapitals', converterjs.makeSmallCapitals);
  }
};
