...
module.exports = {
  config: {
    rtInitialProjectPath: {
      title: "Initial path for a new latex project",
      type: 'string',
      "default": 'C:\\my-latex-project'
    },
    rtGenerateEasyCodeInsert: {
      title: "Inlcude and easy way to add code to your latex project",
      type: 'boolean',
      "default": true
    },
    rtGenerateGlossary: {
      title: "Generate glossary on new latex project initialization",
      type: 'boolean',
      "default": true
    }
  },
